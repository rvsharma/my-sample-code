...
export default function MyHealhPlan({
  goToSubStep,
  configData,
  setConfigData,
}: ownProps): JSX.Element {
  const addressableSpace = configData.modules.find(
    (x: any) => x.module === MODULE_NAMES.MYHEALTH_PLAN
  ...
  return (
    <>
      ...
      <div className='row member-signup-container shadow py-2 mt-4'>
        ...
        <Sections
          data={configData}
          module={MODULE_NAMES.MYHEALTH_PLAN}
      ...
      <div className='row pt-5 pb-5 tab-button justify-content-center justify-content-sm-end'>
        ...
        <div className='col-auto'>
          <button
            ...
            onClick={() => goToSubStep(MODULE_NAMES.DOCTOR_SERVICES)}>
            Next
          </button>
        </div>
      </div>
