...
export default function Dashboard({
  ...
  const addressableSpace = configData.modules.find((x: any) => x.module === MODULE_NAMES.DASHBOARD)
                    ...
                    <div className='row mt-3'>
                      <div className='col-12 position-relative'>
                        <HOCTable
                          ...
                          parentIndex={index}
                        />
                        {/* <div className='row pt-2 pb-2 tab-button justify-content-center justify-content-sm-end'>
                        ...
                        <div className='col-auto'>
                          <button type='button' className='btn btn-blue-next text-white btn-radius'>
                            Save
                          </button>
                        </div>
                      </div> */}
      ...
      <div className='row pt-5 pb-5 tab-button justify-content-center justify-content-sm-end'>
        ...
        <div className='col-auto'>
          <button
            ...
            onClick={() => goToSubStep(MODULE_NAMES.MYHEALTH_PLAN)}>
            Next
          </button>
        </div>
      </div>
